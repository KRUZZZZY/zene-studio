 ...
 * 170 / 90 / 13 / 4 / 63 with the client in - which these reduce to. The six
...
{
	DocumentedHistogram out{168, 90, 13, 4, 61};   // telemetry-off, wasm-off base; the guards add the rest
...
private slots:
	...
	//! At 0.3.0 the same four counts read 90 / 13 / 4 / 63 over 170 rows, and the
	...
	//! no wasmtime, so the notes' own figures are its 170 / 90 / 13 / 4 / 63.
