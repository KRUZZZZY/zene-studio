 ...
 * gets left stale.
 *
 * The release notes quote the RELEASE configuration's figures - 197 rows /
 * 111 / 14 / 4 / 68 with the telemetry client compiled out and no wasmtime,
 * 199 / 111 / 14 / 4 / 70 with the client in - which these reduce to. The six
...
{
	DocumentedHistogram out{197, 111, 14, 4, 68};   // telemetry-off, wasm-off base; the guards add the rest
...
private slots:
	...
	//! At 0.3.0 the same four counts read 87 / 14 / 4 / 62 over 167 rows, and the
