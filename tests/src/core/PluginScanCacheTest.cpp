...
void PluginScanCacheTest::initTestCase()
{
...
void PluginScanCacheTest::cleanupTestCase()
{
	m_pluginDir.reset();
	m_cacheDir.reset();
}
...
void PluginScanCacheTest::testCacheRoundTrip()
{
...
void PluginScanCacheTest::testLookupMissesOnChangedFingerprint()
{
	using namespace lmms;
...
void PluginScanCacheTest::testQuarantineSurvivesSaveAndLoad()
{
	using namespace lmms;
...
void PluginScanCacheTest::testCorruptCacheDegradesToFullScan()
{
	using namespace lmms;
...
void PluginScanCacheTest::testRealPluginIsScannedThenServedFromCache()
{
	using namespace lmms;
...
void PluginScanCacheTest::testChangedPluginFileIsRescanned()
{
	using namespace lmms;
...
void PluginScanCacheTest::testCacheHitDoesNotLoadTheLibrary()
{
	using namespace lmms;
...
void PluginScanCacheTest::testQuarantinedPluginIsHiddenFromDiscovery()
{
	using namespace lmms;
...
void PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain()
{
	using namespace lmms;
...
void PluginScanCacheTest::testCacheDisabledBehavesLikeAColdCache()
{
	using namespace lmms;
...
void PluginScanCacheTest::testPluginBrowserDefersDiscoveryToFirstShow()
{
	using namespace lmms;
