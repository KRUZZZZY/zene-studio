--! zene-api 0.1
--
-- create-pattern.lua - Zene Studio Lua API v0 example 1 (spec section 7).
--
...
local step = zene.ticksPerBar() / 16   -- one 16th note, in ticks
local accent = 112
local ghost = 72
...
zene.log():info(string.format("create-pattern: %d notes in '%s' on '%s'",
