...
Commit `023770f7b` (the implementation) was left committed; the working tree was patched back to
"feature not implemented" so the test binary still compiles and runs against the real API. Exactly
five changes made the red state:
...
i.e. the tree as it was before this lane, with the new API present but inert.

```
cd /home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan
cmake --build build -j 6 --target PluginScanCacheTest          # BUILD_EXIT=0
cd build/tests
...
QINFO  : PluginScanCacheTest::initTestCase() fixture plugin dir: "/tmp/zene-scan-plugins-rQYxhZ" module copied: true
PASS   : PluginScanCacheTest::initTestCase()
FAIL!  : PluginScanCacheTest::testCacheRoundTrip() 'reloaded.load()' returned FALSE. ()
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(278)]
FAIL!  : PluginScanCacheTest::testLookupMissesOnChangedFingerprint() 'cache.lookup(file) != nullptr' returned FALSE. ()
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(320)]
FAIL!  : PluginScanCacheTest::testQuarantineSurvivesSaveAndLoad() Compared values are not the same
   ...
   Expected (1)                      : 1
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(347)]
...
FAIL!  : PluginScanCacheTest::testCorruptCacheDegradesToFullScan() 'rewritten.load()' returned FALSE. (the scan must replace a corrupt cache with a valid one)
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(397)]
...
FAIL!  : PluginScanCacheTest::testRealPluginIsScannedThenServedFromCache() 'QFileInfo::exists(cacheFile)' returned FALSE. (the first scan must write the cache)
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(427)]
...
FAIL!  : PluginScanCacheTest::testChangedPluginFileIsRescanned() Compared values are not the same
   ...
   Expected (1)                                 : 1
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(469)]
...
QWARN  : PluginScanCacheTest::testCacheHitDoesNotLoadTheLibrary() "LMMS plugin /tmp/zene-scan-plugins-rQYxhZ/liblazyprobe.so does not have a plugin descriptor named lazyprobe_plugin_descriptor!"
...
FAIL!  : PluginScanCacheTest::testCacheHitDoesNotLoadTheLibrary() Compared values are not the same
   ...
   Expected (1)                          : 1
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(536)]
...
FAIL!  : PluginScanCacheTest::testQuarantinedPluginIsHiddenFromDiscovery() Compared values are not the same
   ...
   Expected (1)                                  : 1
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(575)]
...
QWARN  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() Cannot load library /tmp/zene-scan-plugins-rQYxhZ/libnotaplugin.so: (/tmp/zene-scan-plugins-rQYxhZ/libnotaplugin.so: file too short)
...
FAIL!  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() Compared values are not the same
   ...
   Expected (0)                         : 0
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(628)]
...
FAIL!  : PluginScanCacheTest::testPluginBrowserDefersDiscoveryToFirstShow() '!PluginFactory::instanceExists()' returned FALSE. (constructing the plugin browser must not trigger plugin discovery)
   Loc: [/home/kruzzzzy/Documents/AI_KOS_PROJECT/projects/lmms-fl-research/zene-pa-scan/tests/src/core/PluginScanCacheTest.cpp(692)]
PASS   : PluginScanCacheTest::cleanupTestCase()
Totals: 3 passed, 10 failed, 0 skipped, 0 blacklisted, 46ms
...
********* Start testing of PluginScanCacheTest *********
Config: Using QtTest library 6.4.2, Qt 6.4.2 (x86_64-little_endian-lp64 shared (dynamic) release build; by GCC 13.2.0), ubuntu 24.04
QINFO  : PluginScanCacheTest::initTestCase() fixture plugin dir: "/tmp/zene-scan-plugins-IZIqOR" module copied: true
PASS   : PluginScanCacheTest::initTestCase()
...
QWARN  : PluginScanCacheTest::testCorruptCacheDegradesToFullScan() plugin-scan-cache: ignoring corrupt cache "/tmp/zene-scan-cache-XWCwLB/corrupt.json" - "unterminated object" - scanning all plugins
QWARN  : PluginScanCacheTest::testCorruptCacheDegradesToFullScan() plugin-scan-cache: ignoring corrupt cache "/tmp/zene-scan-cache-XWCwLB/corrupt.json" - "unterminated object" - scanning all plugins
QINFO  : PluginScanCacheTest::testCorruptCacheDegradesToFullScan() plugin-scan: 1 file(s), 0 quarantined, 0 served from cache, 0 known-bad skipped, 1 scanned, 1 plugin(s)
...
QINFO  : PluginScanCacheTest::testQuarantinedPluginIsHiddenFromDiscovery() plugin-scan: 1 file(s), 1 quarantined, 0 served from cache, 0 known-bad skipped, 0 scanned, 0 plugin(s); skipped /tmp/zene-scan-plugins-IZIqOR/libtripleoscillator.so (hung the host on load)
QINFO  : PluginScanCacheTest::testQuarantinedPluginIsHiddenFromDiscovery() plugin-scan: 1 file(s), 1 quarantined, 0 served from cache, 0 known-bad skipped, 0 scanned, 0 plugin(s); skipped /tmp/zene-scan-plugins-IZIqOR/libtripleoscillator.so (hung the host on load)
PASS   : PluginScanCacheTest::testQuarantinedPluginIsHiddenFromDiscovery()
QINFO  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() plugin-scan: 0 file(s), 0 quarantined, 0 served from cache, 0 known-bad skipped, 0 scanned, 0 plugin(s)
QWARN  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() Cannot load library /tmp/zene-scan-plugins-IZIqOR/libnotaplugin.so: (/tmp/zene-scan-plugins-IZIqOR/libnotaplugin.so: file too short)
QINFO  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() plugin-scan: 2 file(s), 0 quarantined, 0 served from cache, 0 known-bad skipped, 2 scanned, 1 plugin(s)
QINFO  : PluginScanCacheTest::testKnownBadFileIsNotLoadedAgain() plugin-scan: 0 file(s), 0 quarantined, 0 served from cache, 0 known-bad skipped, 0 scanned, 0 plugin(s)
...
PASS   : PluginScanCacheTest::cleanupTestCase()
Totals: 13 passed, 0 failed, 0 skipped, 0 blacklisted, 67ms
********* Finished testing of PluginScanCacheTest *********
TEST_EXIT=0
```
...
Note on the CI invocation: the CI's `CMAKE_OPTS` are used byte for byte; the script adds
`-DWANT_QT6=ON` on this box (no Qt5 development files) and prints that as a deviation, per its own
contract.
